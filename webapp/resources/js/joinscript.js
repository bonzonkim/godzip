...
const text = document.querySelector("#memberEmail");
...
const pwd2 = document.querySelector("input[name=confirmMemberPwd]");
...
pwd.addEventListener("blur",()=>{
  ...
  //최소 1개의 문자 포함한 6~12자리
  const result = reg.test(pwdCheck);
  const text = document.querySelector("#memberPwd");
