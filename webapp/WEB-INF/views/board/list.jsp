...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="/resources/css/util/list.css">
</head>
<body>
  ...
  <%@include file="/WEB-INF/views/common/header.jsp" %>
        ...
        <main>
            ...
            <c:if test="${memberLog != null}">
              <div id="button-wrap">
                <button id="writeBtn" onclick="location.href='/board/write'">
            ...
            <div id="prev-next-btn-wrap">
              <c:if test="${paginationVo.currentPage > 1}">
                <a href="/board/list?page=${paginationVo.currentPage-1}">◁</a>
              </c:if>
              ...
              <c:if test="${paginationVo.currentPage < paginationVo.maxPage}">
                <a href="/board/list?page=${paiginationVo.currentPage+1}">▷</a>
              </c:if>
            </div>
