...
<head>
<meta charset="UTF-8">
    <link rel="stylesheet" href="/resources/css/member/myPost_report-style.css">
	    ...
	    <div class="reviewTot">
	        <div class="reviewList">
	            <div class="list Top">
	                ...
	                <div class="reviewWriter twriter"><h5>REASON</h5></div>
	                <div class="reviewDate tdate"><h5>DATE</h5></div>
	            </div>
	            <div class="list li l20">
	                <div class="reviewNum num n20"><h5>20</h5></div>
	                <div><img src="img/no_sign.PNG"></div>
	                <div id="reviewTitle title t20"><a href=""><h5>ㅅ1ㅂr</h5></a></div>
	                <div class="reviewWriter writer w20"><h5>부적절한 언어 사용</h5></div>
