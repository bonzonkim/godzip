        ...
        <form action="/member/join" method="post" class="memberJoin" onsubmit="return validateForm()">
            <div id="table1Div">
                <table id="table1">
                    ...
                    <tr id= "imgInTable">
                        <td>
                            <img alt="로고사진" src="/resources/img/godzip_white_cropped.PNG" width="200px;" style="margin-left:50%;">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td id="robot" colspan="3">
                            ...
                            <div class="captcha-submit">
                                <div id="recaptcha" class="g-recaptcha" data-sitekey="6LeCtDklAAAAAJH05a2u4mNQPJ-DFQlP3qQlGQ-P" data-callback="onSubmit"></div>
