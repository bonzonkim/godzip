...
<link rel="stylesheet" href="/resources/css/admin/admin_login_style.css">
<script defer src="/resources/js/login.js"></script>

<body>


  <form class="login" action="/admin/aintnobodycantaccesshere" method="post">
    <h1 id="login">로그인</h1>
    ...
    <button>
      ...
      <span class="now">로그인!!!</span>
      <span class="play">관리자</span>
    </button>
