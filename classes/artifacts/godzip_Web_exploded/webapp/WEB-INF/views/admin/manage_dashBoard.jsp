...
<body>
	...
	<div id="wrap">
		...
		<div class="reviewTot">
		    <div id="manageButton">
				<div id="report"><button onclick="location.href='/admin/control'"><span>Report</span></button></div>
				<div id="member"><button onclick="location.href='/admin/control'"><span>Members</span></button></div>
		        <div id="upload"><button onclick="location.href='/admin/write'"><span>Upload</span></button></div>
