...
<body>
    <div id="childTopDiv">
        <div id="toptopBox">
            ...
            <semi:if test="${adminLog != null}">
                <input type="button" class="searchButton" name="administrator" value="Administration" onclick="location.href = '/admin/manage';">
                <input type="button" class="searchButton" name="administratorLogout" value="Logout" onclick="location.href = '/admin/logout';">
            </semi:if>
            <div id="loginOutBox">
            <semi:if test="${loginMember == null && adminLog == null}">
